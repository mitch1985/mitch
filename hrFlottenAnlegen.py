...
for planetenIndexAndKoords in meinePlaneten:
    ...
    while isBotschutz:
        response = requests.get(
            f'http://www.earthlost.de/construction.phtml?planetindex={planetenIndexAndKoordsSplit[0]}&sid={sid}').text
        hrFlotteErstellen = {'sid': sid,
                             'newfleetname': 'HR ' + einzelKoordinaten[0] + ':' + einzelKoordinaten[1] + ':' +
                                             einzelKoordinaten[2]}
